...
\subsubsection{Idea generale}
In questa soluzione al problema si è pensato di considerare la scomposizione delle serie nelle 
...
la cui stagionalità raccolga la maggior parte dell'informazione di un passo. Per fare ciò è stato 
